...
import { loadGame, loadSettings, saveGame } from '../../utils/gameState';
import Cards from './../../components/Cards/CardsStyled';
...
class Game extends Component {
    ...
    addCardAttempt(id, name) {
        ...
        let cardAttemptsCount = this.state.cardAttemptsCount

        this.setState({
            cardAttempts,
            cardAttemptsCount: ++cardAttemptsCount
        })
    }
